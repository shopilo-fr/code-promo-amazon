#!/usr/bin/env python3
"""
Recuperation des codes promo Amazon depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/amazon.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/amazon.fr"
STORE_NAME = "Amazon"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Amazon depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-amazon)"
    }
    try:
